...
public class Anchor2 {
    ...
    public static Anchor2 objectFromData(String str) {

        return new Gson().fromJson(str, Anchor2.class);
    }

    public static Anchor2 objectFromData(String str, String key) {

        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getJSONObject(key).toString(), Anchor2.class);
    ...
    public static List<Anchor2> arrayAnchor3FromData(String str) {

        Type listType = new TypeToken<ArrayList<Anchor2>>() {
        }.getType();

        return new Gson().fromJson(str, listType);
    }

    public static List<Anchor2> arrayAnchor3FromData(String str, String key) {
